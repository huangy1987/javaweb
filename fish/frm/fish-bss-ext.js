!function() {
    ...
    var templateStr = '<div class="ui-dialog dialog-danger">\
	    ...
	    <div class="modal-footer text-right">\
			...
			<button type="button" class="btn btn-primary js-warn">一键报障</button>\
...
!function() {
	...
	$.widget("ui.slidingdoor", {
		...
		_create : function() {
			var This = this;
			var html = '<div class="slidingDoor js-slidingDoorDiv">\
							<div class="sliding-panel js-slidingDoor-content">\
							</div>\
						</div>';
			
			$("body").append(html);
			This.$slidingDoor = $(".js-slidingDoorDiv");
			This.$slidingDoorC = $(".js-slidingDoor-content");
			
			if(this.options.viewUrl !=''){
				// 读取传入的视图对象
				require([this.options.viewUrl],function(SubView){
					var subView = new SubView();
					This.$slidingDoorC.append(subView.template());
				});
	...
	$.widget('ui.grid',$.ui.grid,{
        ...
        addTreeLine: function () {
        	...
        	_.each(trArr, function (item, index, list) {
        		...
        		console.log("current datalevel is " + dataLevel);
        		...
        		if (dataLevel != undefined) {
            		...
            		if (dataLevel == currentSiblingDataLevel) {
            			//当前item为当前序列的同胞元素
            			console.log("dataLevel " + currentSiblingDataLevel + "'s sibling");
            			console.log("current dataLevel is " + dataLevel);
            			...
            			// 上一个item为当前序列的父元素
            			console.log("dataLevel " + currentSiblingDataLevel + "'s children");
            			console.log("current dataLevel is " + dataLevel);
